  ...
  return (
    <form onSubmit={onSubmit} className={classes.companyRegisterForm}>
      ...
      <div className={classes.twoColumn}>
        <FormInput setRef={setCompanyName} title="Company Name" required placeholder="Enter your company name here" variant="outlined" type="text"></FormInput>
        <FormInput setRef={setPhoneNumber} title="Phone" required placeholder="Enter your phone number here" variant="outlined" type="text"></FormInput>
      </div>
      <div className={classes.twoColumn}>
        <FormInput setRef={setCountry} title="Country" required placeholder="e.g. Thailand, Paris, Malaysia" variant="outlined" type="text" />
        <FormInput setRef={setProvince} title="Province" required placeholder="e.g. Bangkok, Nonthaburi, Saraburi" variant="outlined" type="text" />
      </div>
